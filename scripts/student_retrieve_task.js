        ...
        .onSnapshot(function (querySnapshot) {
            ...
            if(querySnapshot.size !== 0){
                querySnapshot.forEach(function(doc) {
                    output += '<div class="card-header" style="height: 70px; padding: 20px 20px; font-size: 20px; cursor: pointer" onclick="studentSelectThisTask(\'' + doc.id + '\')">';
...
function studentSelectThisTask(taskId) {
